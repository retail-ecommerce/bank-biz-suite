...
import TransactionBizApp from './transaction/Transaction.app';
import TransactionModel from './transaction/Transaction.model';
import TransactionDashboard from './transaction/Transaction.dashboard';
import TransactionModalTable from './transaction/Transaction.modaltable';
import TransactionSearch from './transaction/Transaction.search';
import TransactionSearchForm from './transaction/Transaction.searchform';
import TransactionCreateForm from './transaction/Transaction.createform';
import TransactionAssociateForm from './transaction/Transaction.associateform';
import TransactionTable from './transaction/Transaction.table';
import TransactionPermission from './transaction/Transaction.permission';
...
import AccountAssociateForm from './account/Account.associateform';
import AccountTable from './account/Account.table';
import AccountPermission from './account/Account.permission';
import AccountProfile from './account/Account.profile';
import AccountService from './account/Account.service';
import AccountUpdateForm from './account/Account.updateform';
import AccountChangeBase from './accountchange/AccountChange.base';
import AccountChangeBizApp from './accountchange/AccountChange.app';
import AccountChangeModel from './accountchange/AccountChange.model';
import AccountChangeDashboard from './accountchange/AccountChange.dashboard';
import AccountChangeModalTable from './accountchange/AccountChange.modaltable';
import AccountChangeSearch from './accountchange/AccountChange.search';
import AccountChangeSearchForm from './accountchange/AccountChange.searchform';
import AccountChangeCreateForm from './accountchange/AccountChange.createform';
import AccountChangeAssociateForm from './accountchange/AccountChange.associateform';
import AccountChangeTable from './accountchange/AccountChange.table';
import AccountChangePermission from './accountchange/AccountChange.permission';
import AccountChangeProfile from './accountchange/AccountChange.profile';
import AccountChangeService from './accountchange/AccountChange.service';
import AccountChangeUpdateForm from './accountchange/AccountChange.updateform';
...
const ViewMapping = {
  ...
  'com.doublechain.bank.userwhitelist.UserWhiteList': {name:'userWhiteList'},
  ...
  'com.doublechain.bank.candidatecontainer.CandidateContainer': {name:'candidateContainer'},
  'com.doublechain.bank.candidateelement.CandidateElement': {name:'candidateElement'},
...
const OOTBComponents={
    ...
    AccountChangeBizApp,
    AccountChangeModel,
    AccountChangeDashboard,
    AccountChangeModalTable,
    AccountChangeSearch,
    AccountChangeSearchForm,
    AccountChangeCreateForm,
    AccountChangeAssociateForm,
    AccountChangeTable,
    AccountChangePermission,
