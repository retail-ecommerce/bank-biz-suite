...
const testValues = {
  name: '存款交易',
  previousBalance: '1246.31',
  type: '存款',
  amount: '108.68',
  currentBalance: '1235.02',
  accountId: 'A000001',
...
class AccountChangeCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addAccountChange`,
          payload: { id: owner.id, type: 'accountChange', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'accountChange',listName:appLocaleName(userContext,"List") },
      })
    }
...
}))(Form.create()(AccountChangeCreateForm))
