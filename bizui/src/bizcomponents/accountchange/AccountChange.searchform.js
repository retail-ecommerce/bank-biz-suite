...
class AccountChangeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      accountChangeList: 1,
      'accountChangeList.searchField': fieldName,
      'accountChangeList.searchVerb': 'startsWith',
      'accountChangeList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        accountChangeSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(AccountChangeSearchForm)
