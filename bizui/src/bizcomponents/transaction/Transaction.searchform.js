...
class TransactionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      transactionList: 1,
      'transactionList.searchField': fieldName,
      'transactionList.searchVerb': 'startsWith',
      'transactionList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'fromAccount'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'toAccount'))
      ...
      dispatch({
        ...
        transactionSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(TransactionSearchForm)
