...
import styles from './Transaction.updateform.less'
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, transactionId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateTransaction`,
          payload: {
            id: owner.id,
            type: 'transaction',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextTransactionUpdateRow`,
        payload: {
          id: owner.id,
          type: 'transaction',
          selectedRows,
...
}))(Form.create()(TransactionUpdateForm))
