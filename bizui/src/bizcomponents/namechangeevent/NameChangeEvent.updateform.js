...
import styles from './NameChangeEvent.updateform.less'
...
class NameChangeEventUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const nameChangeEventId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, nameChangeEventId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateNameChangeEvent`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextNameChangeEventUpdateRow`,
        payload: {
          id: owner.id,
          type: 'nameChangeEvent',
          selectedRows,
...
}))(Form.create()(NameChangeEventUpdateForm))
