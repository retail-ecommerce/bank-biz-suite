...
import styles from './NameChangeEvent.createform.less'
import {mapBackToImageValues, mapFromImageValues} from '../../axios/tools'
import GlobalComponents from '../../custcomponents';
import NameChangeEventBase from './NameChangeEvent.base'
...
class NameChangeEventCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const {fieldLabels} = NameChangeEventBase
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addNameChangeEvent`,
          payload: { id: owner.id, type: 'nameChangeEvent', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'nameChangeEvent',listName:appLocaleName(userContext,"List") },
      })
    }
...
}))(Form.create()(NameChangeEventCreateForm))
