...
class NameChangeEventSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      nameChangeEventList: 1,
      'nameChangeEventList.searchField': fieldName,
      'nameChangeEventList.searchVerb': 'startsWith',
      'nameChangeEventList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'account'))
      ...
      dispatch({
        ...
        nameChangeEventSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(NameChangeEventSearchForm)
