...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.NameChangeEventBase.renderItemOfList(item, targetComponents)

}



class NameChangeEventProfile extends Component {
...
}))(Form.create()(NameChangeEventProfile))
