-- BUILD WITH MODEL TIME 190820T1606
...
insert into platform_data values
	('P000001','银行模拟平台','2019-08-06 16:54:55','1'),
	('P000002','银行模拟平台','2019-08-02 08:12:51','1');

insert into change_request_data values
	('CR000001','存款','2019-08-17 05:22:11','P000001','1'),
	('CR000002','转账','2019-08-12 08:24:52','P000001','1'),
	('CR000003','取款','2019-08-06 08:55:27','P000002','1');

insert into transaction_data values
	('T000001','存款交易','A000001','A000001','112.84','存款','CR000001','1'),
	('T000002','存款交易','A000001','A000001','118.04','存款','CR000001','1'),
	('T000003','取款交易','A000002','A000002','114.48','取款','CR000002','1'),
	('T000004','存款交易','A000003','A000003','104.57','存款','CR000003','1');
...
insert into account_data values
	('A000001','张三账户','88.36','2019-08-12 07:14:00','2019-08-01 03:30:39','P000001','1'),
	('A000002','李四账户','106.24','2019-08-02 13:40:10','2019-07-30 21:36:12','P000001','1'),
	('A000003','银行账户','95.19','2019-08-11 05:26:07','2019-07-29 23:11:11','P000002','1');

insert into account_change_data values
	('AC000001','存款交易','A000001','923.82','存款','104.39','948.48','CR000001','1'),
	('AC000002','存款交易','A000001','1213.74','存款','103.04','1022.20','CR000001','1'),
	('AC000003','取款交易','A000002','1039.48','取款','113.27','1160.82','CR000002','1'),
	('AC000004','存款交易','A000003','1247.14','存款','106.39','1084.12','CR000003','1');
...
insert into sec_user_data values
	('SU000001','login','13900000001','','C183EC89F92A462CF45B95504792EC4625E847C90536EEFE512D1C9DB8602E95','wx123456789abcdefghijklmn','wxapp12098410239840','jwt_token_12345678','0','2019-07-31 11:54:25','2019-08-19 04:12:16','UD000001',NULL,'BLOCKED','1'),
	('SU000002','login0002','13900000002','suddy_chang@163.com','AC2F95628244C6975EB2C36942EA879ED93D93F5895EF3157733E4629FA86B92','wx123456789abcdefghijklmn0002','wxapp120984102398400002','jwt_token_123456780002','9999999','2019-08-01 07:50:20','2019-08-03 03:25:50','UD000001',NULL,'BLOCKED0002','1');

insert into sec_user_blocking_data values
	('SUB000001','currentUser()','2019-08-07 04:50:06','这个用户多次发送违反社区的帖子，现在把他给屏蔽了','1');
...
insert into login_history_data values
	('LH000001','2019-08-02 00:31:56','192.168.1.1','登陆成功','SU000001','1'),
	('LH000002','2019-08-10 00:39:13','192.168.1.2','登陆成功0002','SU000001','1'),
	('LH000003','2019-08-07 08:52:27','192.168.1.1','登陆成功0003','SU000002','1'),
	('LH000004','2019-07-30 02:07:30','192.168.1.2','登陆成功0004','SU000002','1');
