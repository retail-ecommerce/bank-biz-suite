...
public class DBQueryBuilder {
    ...
    public static void main(String[] args) {
        DBQueryBuilder dbb = new DBQueryBuilder("job_order_data")
                .with("status", null).without("driver", "jackytian");


        DBQueryBuilder sub = dbb.subQuery("line_item_data").with("age", "10");

        dbb.inSub("line_item_id", sub);


        userInWarehouse(dbb, "U0001", "MW00001");
        System.out.println(dbb.toQuery());
