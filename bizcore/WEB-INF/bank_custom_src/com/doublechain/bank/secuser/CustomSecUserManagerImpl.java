...
import com.doublechain.bank.BankUserContextImpl;
import com.doublechain.bank.LoginForm;
import com.doublechain.bank.BaseEntity;
import com.doublechain.bank.CommonError;
import com.doublechain.bank.DAOGroup;
import com.doublechain.bank.ManagerGroup;

import com.doublechain.bank.UserContextImpl;
import com.doublechain.bank.userapp.UserApp;
import com.doublechain.bank.BankUserContext;
import com.doublechain.bank.userapp.*;
import com.doublechain.bank.listaccess.*;
import com.doublechain.bank.objectaccess.*;
import com.doublechain.bank.BankObjectChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(BankUserContext userContext){
    ...
    public Object resetPassword(BankUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(BankUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(BankUserContext userContext,
    ...
    public SecUser manage(BankUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(BankUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(BankUserContext userContext) {
    ...
    protected Object gotoApp(BankUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(BankUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(BankUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected String getBeanName(BankUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(BankUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(BankUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(BankUserContext userContext, UserApp app){
    ...
    public Object home(BankUserContext userContext) {
    ...
    public Object loginWithEmail(BankUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(BankUserContext userContext, String email,
            Password password) {
    ...
    public Object loginWithLogin(BankUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(BankUserContext userContext, String email,
            Password password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(BankUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(BankUserContext userContext, String type, String userId,
            Password password) {
    ...
    public Object showlogin(BankUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        BankUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected BankObjectChecker checker;
    public BankObjectChecker getChecker(){
        return checker;
    }
    
    public void setChecker(BankObjectChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((BankObjectChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected BankUserContextImpl createNewConext(String path) {
        ...
        return new BankUserContextImpl();
    ...
    public Object checkOtherLogin(BankUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(BankUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(BankUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(BankUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(BankUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(BankUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(BankUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
    ...
    public Map<String, Object> testoss(BankUserContext userContext) throws SecUserManagerException {
