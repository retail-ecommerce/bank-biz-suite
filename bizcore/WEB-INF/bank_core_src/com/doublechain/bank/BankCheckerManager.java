...
public class BankCheckerManager extends BaseManagerImpl {
	...
	protected void checkIdOfPlatform(BankUserContext userContext, String id, List<Message> messageList)
	{
		
	 	checkStringLengthRange(id,2, 64,ID_OF_PLATFORM, messageList); 		
	...
	protected void checkVersionOfPlatform(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfChangeRequest(BankUserContext userContext, String id, List<Message> messageList)
	{
		
	 	checkStringLengthRange(id,2, 64,ID_OF_CHANGE_REQUEST, messageList); 		
		
	}	 			
	
	public static final String  NAME_OF_CHANGE_REQUEST ="change_request.name";
	protected void checkNameOfChangeRequest(BankUserContext userContext, String name, List<Message> messageList)
	{
		
	 	checkStringLengthRange(name,1, 8,NAME_OF_CHANGE_REQUEST, messageList); 		
		
	}	 			
	
	public static final String  PLATFORM_OF_CHANGE_REQUEST ="change_request.platform";
	protected void checkPlatformIdOfChangeRequest(BankUserContext userContext, String platformId, List<Message> messageList)
	{
		
	 	checkIdOfChangeRequest(userContext,platformId, messageList); 		
		
	}	 			
	
	public static final String  VERSION_OF_CHANGE_REQUEST ="change_request.version";
	protected void checkVersionOfChangeRequest(BankUserContext userContext, int version, List<Message> messageList)
	{
		
	 	checkIntegerRange(version,0, Integer.MAX_VALUE,VERSION_OF_CHANGE_REQUEST, messageList); 		
		
	}	 			
	
	public static final String  ID_OF_TRANSACTION ="transaction.id";
	protected void checkIdOfTransaction(BankUserContext userContext, String id, List<Message> messageList)
	{
		
	 	checkStringLengthRange(id,2, 64,ID_OF_TRANSACTION, messageList); 		
		
	}	 			
	
	public static final String  NAME_OF_TRANSACTION ="transaction.name";
	protected void checkNameOfTransaction(BankUserContext userContext, String name, List<Message> messageList)
	{
		
	 	checkStringLengthRange(name,2, 16,NAME_OF_TRANSACTION, messageList); 		
		
	}	 			
	
	public static final String  FROM_ACCOUNT_OF_TRANSACTION ="transaction.from_account";
	protected void checkFromAccountIdOfTransaction(BankUserContext userContext, String fromAccountId, List<Message> messageList)
	{
		
	 	checkIdOfTransaction(userContext,fromAccountId, messageList); 		
		
	}	 			
	
	public static final String  TO_ACCOUNT_OF_TRANSACTION ="transaction.to_account";
	protected void checkToAccountIdOfTransaction(BankUserContext userContext, String toAccountId, List<Message> messageList)
	{
		
	 	checkIdOfTransaction(userContext,toAccountId, messageList); 		
		
	}	 			
	
	public static final String  AMOUNT_OF_TRANSACTION ="transaction.amount";
	protected void checkAmountOfTransaction(BankUserContext userContext, BigDecimal amount, List<Message> messageList)
	{
		
	 	checkMoneyAmount(amount,0.00, 123.00,AMOUNT_OF_TRANSACTION, messageList); 		
		
	}	 			
	
	public static final String  TYPE_OF_TRANSACTION ="transaction.type";
	protected void checkTypeOfTransaction(BankUserContext userContext, String type, List<Message> messageList)
	{
		
	 	checkStringLengthRange(type,1, 8,TYPE_OF_TRANSACTION, messageList); 		
	...
	protected void checkIdOfAccount(BankUserContext userContext, String id, List<Message> messageList)
	{
	 	...
	 	checkStringLengthRange(id,2, 64,ID_OF_ACCOUNT, messageList); 		
		
	}	 			
	
	public static final String  NAME_OF_ACCOUNT ="account.name";
	protected void checkNameOfAccount(BankUserContext userContext, String name, List<Message> messageList)
	{
		
	 	checkStringLengthRange(name,2, 16,NAME_OF_ACCOUNT, messageList); 		
		
	}	 			
	
	public static final String  BALANCE_OF_ACCOUNT ="account.balance";
	protected void checkBalanceOfAccount(BankUserContext userContext, BigDecimal balance, List<Message> messageList)
	{
		
	 	checkMoneyAmount(balance,0.00, 123.00,BALANCE_OF_ACCOUNT, messageList); 		
		
	}	 			
	
	public static final String  PLATFORM_OF_ACCOUNT ="account.platform";
	protected void checkPlatformIdOfAccount(BankUserContext userContext, String platformId, List<Message> messageList)
	{
		
	 	checkIdOfAccount(userContext,platformId, messageList); 		
		
	}	 			
	
	public static final String  VERSION_OF_ACCOUNT ="account.version";
	protected void checkVersionOfAccount(BankUserContext userContext, int version, List<Message> messageList)
	{
		
	 	checkIntegerRange(version,0, Integer.MAX_VALUE,VERSION_OF_ACCOUNT, messageList); 		
		
	}	 			
	
	public static final String  ID_OF_ACCOUNT_CHANGE ="account_change.id";
	protected void checkIdOfAccountChange(BankUserContext userContext, String id, List<Message> messageList)
	{
		
	 	checkStringLengthRange(id,2, 64,ID_OF_ACCOUNT_CHANGE, messageList); 		
		
	}	 			
	
	public static final String  NAME_OF_ACCOUNT_CHANGE ="account_change.name";
	protected void checkNameOfAccountChange(BankUserContext userContext, String name, List<Message> messageList)
	{
		
	 	checkStringLengthRange(name,2, 16,NAME_OF_ACCOUNT_CHANGE, messageList); 		
	...
	protected void checkPreviousBalanceOfAccountChange(BankUserContext userContext, BigDecimal previousBalance, List<Message> messageList)
	{
	 	...
	 	checkMoneyAmount(previousBalance,0.00, 1312.00,PREVIOUS_BALANCE_OF_ACCOUNT_CHANGE, messageList); 		
		
	}	 			
	
	public static final String  TYPE_OF_ACCOUNT_CHANGE ="account_change.type";
	protected void checkTypeOfAccountChange(BankUserContext userContext, String type, List<Message> messageList)
	{
		
	 	checkStringLengthRange(type,1, 8,TYPE_OF_ACCOUNT_CHANGE, messageList); 		
		
	}	 			
	
	public static final String  AMOUNT_OF_ACCOUNT_CHANGE ="account_change.amount";
	protected void checkAmountOfAccountChange(BankUserContext userContext, BigDecimal amount, List<Message> messageList)
	{
		
	 	checkMoneyAmount(amount,0.00, 123.00,AMOUNT_OF_ACCOUNT_CHANGE, messageList); 		
		
	}	 			
	
	public static final String  CURRENT_BALANCE_OF_ACCOUNT_CHANGE ="account_change.current_balance";
	protected void checkCurrentBalanceOfAccountChange(BankUserContext userContext, BigDecimal currentBalance, List<Message> messageList)
	{
		
	 	checkMoneyAmount(currentBalance,0.00, 1312.00,CURRENT_BALANCE_OF_ACCOUNT_CHANGE, messageList); 		
	...
	protected void checkVersionOfAccountChange(BankUserContext userContext, int version, List<Message> messageList)
	{
		
	 	checkIntegerRange(version,0, Integer.MAX_VALUE,VERSION_OF_ACCOUNT_CHANGE, messageList); 		
		
	}	 			
	
	public static final String  ID_OF_USER_DOMAIN ="user_domain.id";
	protected void checkIdOfUserDomain(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfUserDomain(BankUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserDomain(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfUserWhiteList(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkUserIdentityOfUserWhiteList(BankUserContext userContext, String userIdentity, List<Message> messageList)
	{
	...
	protected void checkUserSpecialFunctionsOfUserWhiteList(BankUserContext userContext, String userSpecialFunctions, List<Message> messageList)
	{
	...
	protected void checkDomainIdOfUserWhiteList(BankUserContext userContext, String domainId, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserWhiteList(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfSecUser(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLoginOfSecUser(BankUserContext userContext, String login, List<Message> messageList)
	{
	...
	protected void checkMobileOfSecUser(BankUserContext userContext, String mobile, List<Message> messageList)
	{
	...
	protected void checkEmailOfSecUser(BankUserContext userContext, String email, List<Message> messageList)
	{
	...
	protected void checkPwdOfSecUser(BankUserContext userContext, String pwd, List<Message> messageList)
	{
	...
	protected void checkWeixinOpenidOfSecUser(BankUserContext userContext, String weixinOpenid, List<Message> messageList)
	{
	...
	protected void checkWeixinAppidOfSecUser(BankUserContext userContext, String weixinAppid, List<Message> messageList)
	{
	...
	protected void checkAccessTokenOfSecUser(BankUserContext userContext, String accessToken, List<Message> messageList)
	{
	...
	protected void checkVerificationCodeOfSecUser(BankUserContext userContext, int verificationCode, List<Message> messageList)
	{
	...
	protected void checkVerificationCodeExpireOfSecUser(BankUserContext userContext, DateTime verificationCodeExpire, List<Message> messageList)
	{
	...
	protected void checkLastLoginTimeOfSecUser(BankUserContext userContext, DateTime lastLoginTime, List<Message> messageList)
	{
	...
	protected void checkDomainIdOfSecUser(BankUserContext userContext, String domainId, List<Message> messageList)
	{
	...
	protected void checkVersionOfSecUser(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfSecUserBlocking(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkWhoOfSecUserBlocking(BankUserContext userContext, String who, List<Message> messageList)
	{
	...
	protected void checkCommentsOfSecUserBlocking(BankUserContext userContext, String comments, List<Message> messageList)
	{
	...
	protected void checkVersionOfSecUserBlocking(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfUserApp(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfUserApp(BankUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkSecUserIdOfUserApp(BankUserContext userContext, String secUserId, List<Message> messageList)
	{
	...
	protected void checkAppIconOfUserApp(BankUserContext userContext, String appIcon, List<Message> messageList)
	{
	...
	protected void checkFullAccessOfUserApp(BankUserContext userContext, boolean fullAccess, List<Message> messageList)
	{
	...
	protected void checkPermissionOfUserApp(BankUserContext userContext, String permission, List<Message> messageList)
	{
	...
	protected void checkObjectTypeOfUserApp(BankUserContext userContext, String objectType, List<Message> messageList)
	{
	...
	protected void checkObjectIdOfUserApp(BankUserContext userContext, String objectId, List<Message> messageList)
	{
	...
	protected void checkLocationOfUserApp(BankUserContext userContext, String location, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserApp(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfListAccess(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfListAccess(BankUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkInternalNameOfListAccess(BankUserContext userContext, String internalName, List<Message> messageList)
	{
	...
	protected void checkReadPermissionOfListAccess(BankUserContext userContext, boolean readPermission, List<Message> messageList)
	{
	...
	protected void checkCreatePermissionOfListAccess(BankUserContext userContext, boolean createPermission, List<Message> messageList)
	{
	...
	protected void checkDeletePermissionOfListAccess(BankUserContext userContext, boolean deletePermission, List<Message> messageList)
	{
	...
	protected void checkUpdatePermissionOfListAccess(BankUserContext userContext, boolean updatePermission, List<Message> messageList)
	{
	...
	protected void checkExecutionPermissionOfListAccess(BankUserContext userContext, boolean executionPermission, List<Message> messageList)
	{
	...
	protected void checkAppIdOfListAccess(BankUserContext userContext, String appId, List<Message> messageList)
	{
	...
	protected void checkVersionOfListAccess(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfObjectAccess(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfObjectAccess(BankUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkObjectTypeOfObjectAccess(BankUserContext userContext, String objectType, List<Message> messageList)
	{
	...
	protected void checkList1OfObjectAccess(BankUserContext userContext, String list1, List<Message> messageList)
	{
	...
	protected void checkList2OfObjectAccess(BankUserContext userContext, String list2, List<Message> messageList)
	{
	...
	protected void checkList3OfObjectAccess(BankUserContext userContext, String list3, List<Message> messageList)
	{
	...
	protected void checkList4OfObjectAccess(BankUserContext userContext, String list4, List<Message> messageList)
	{
	...
	protected void checkList5OfObjectAccess(BankUserContext userContext, String list5, List<Message> messageList)
	{
	...
	protected void checkList6OfObjectAccess(BankUserContext userContext, String list6, List<Message> messageList)
	{
	...
	protected void checkList7OfObjectAccess(BankUserContext userContext, String list7, List<Message> messageList)
	{
	...
	protected void checkList8OfObjectAccess(BankUserContext userContext, String list8, List<Message> messageList)
	{
	...
	protected void checkList9OfObjectAccess(BankUserContext userContext, String list9, List<Message> messageList)
	{
	...
	protected void checkAppIdOfObjectAccess(BankUserContext userContext, String appId, List<Message> messageList)
	{
	...
	protected void checkVersionOfObjectAccess(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfLoginHistory(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkFromIpOfLoginHistory(BankUserContext userContext, String fromIp, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfLoginHistory(BankUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkSecUserIdOfLoginHistory(BankUserContext userContext, String secUserId, List<Message> messageList)
	{
	...
	protected void checkVersionOfLoginHistory(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfGenericForm(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfGenericForm(BankUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfGenericForm(BankUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkVersionOfGenericForm(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormMessage(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfFormMessage(BankUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormMessage(BankUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormMessage(BankUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormMessage(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormFieldMessage(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfFormFieldMessage(BankUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkParameterNameOfFormFieldMessage(BankUserContext userContext, String parameterName, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormFieldMessage(BankUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormFieldMessage(BankUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormFieldMessage(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormField(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLabelOfFormField(BankUserContext userContext, String label, List<Message> messageList)
	{
	...
	protected void checkLocaleKeyOfFormField(BankUserContext userContext, String localeKey, List<Message> messageList)
	{
	...
	protected void checkParameterNameOfFormField(BankUserContext userContext, String parameterName, List<Message> messageList)
	{
	...
	protected void checkTypeOfFormField(BankUserContext userContext, String type, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormField(BankUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkPlaceholderOfFormField(BankUserContext userContext, String placeholder, List<Message> messageList)
	{
	...
	protected void checkDefaultValueOfFormField(BankUserContext userContext, String defaultValue, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfFormField(BankUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkFieldGroupOfFormField(BankUserContext userContext, String fieldGroup, List<Message> messageList)
	{
	...
	protected void checkMinimumValueOfFormField(BankUserContext userContext, String minimumValue, List<Message> messageList)
	{
	...
	protected void checkMaximumValueOfFormField(BankUserContext userContext, String maximumValue, List<Message> messageList)
	{
	...
	protected void checkRequiredOfFormField(BankUserContext userContext, boolean required, List<Message> messageList)
	{
	...
	protected void checkDisabledOfFormField(BankUserContext userContext, boolean disabled, List<Message> messageList)
	{
	...
	protected void checkCustomRenderingOfFormField(BankUserContext userContext, boolean customRendering, List<Message> messageList)
	{
	...
	protected void checkCandidateValuesOfFormField(BankUserContext userContext, String candidateValues, List<Message> messageList)
	{
	...
	protected void checkSuggestValuesOfFormField(BankUserContext userContext, String suggestValues, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormField(BankUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormAction(BankUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLabelOfFormAction(BankUserContext userContext, String label, List<Message> messageList)
	{
	...
	protected void checkLocaleKeyOfFormAction(BankUserContext userContext, String localeKey, List<Message> messageList)
	{
	...
	protected void checkActionKeyOfFormAction(BankUserContext userContext, String actionKey, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormAction(BankUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkUrlOfFormAction(BankUserContext userContext, String url, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormAction(BankUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormAction(BankUserContext userContext, int version, List<Message> messageList)
	{
		...
		if (!(baseUserContext instanceof BankUserContext)){
			super.checkAccess(baseUserContext, methodName, parameters);
			return accessOK();
		}
		BankUserContext userContext = (BankUserContext) baseUserContext;
	...
	protected void throwExceptionIfHasErrors(BankUserContext userContext, List<Message> messageList, Class<? extends BankException> exceptionClazz) throws Exception{
		//translate messages;
