...
public class BankBaseUtils {
	...
	public static String getCacheAccessKey(BankUserContext ctx) {
	...
	protected static BaseEntity loadCanCacheInLocal(BankUserContext userContext, String type, String id) throws Exception {
	...
	public static <T extends BaseEntity> List<T> collectReferencedObjectWithType(BankUserContext userContext,
	...
	private static <T extends BaseEntity> void collectReferedObjectIdSet(BankUserContext userContext,
	...
	public static int getAppBuildVersion(BankUserContext ctx) {
		return getBuildVersion(getRequestAppVersion(ctx));
	}
	protected static boolean startFromVersion(BankUserContext ctx, int version) {
     ...
     * "x-app-version" : "9"
	 */
	public static String getRequestAppVersion(BankUserContext userContext) {
		return userContext.getRequestHeader("x-app-version");
	}
	public static String getRequestAppDevice(BankUserContext userContext) {
