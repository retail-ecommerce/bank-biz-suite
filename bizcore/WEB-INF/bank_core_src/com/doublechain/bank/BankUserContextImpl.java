...
import com.doublechain.bank.secuser.SecUserCustomManagerImpl;
...
public class BankUserContextImpl extends UserContextImpl implements BankUserContext{
	...
	static final String RESOURCE_PATH="com.doublechain.bank.BankResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechain.bank.BankCustomResources";
    ...
    /*
    public static SecUser getSecUser(BankUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(BankUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(BankUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(BankUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private BankObjectChecker checker;
