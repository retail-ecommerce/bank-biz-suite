...
public class LoginHistoryManagerImpl extends CustomBankCheckerManager implements LoginHistoryManager {
	...
	protected void throwExceptionWithMessage(String value) throws LoginHistoryManagerException{
 	...
 	protected LoginHistory saveLoginHistory(BankUserContext userContext, LoginHistory loginHistory, String [] tokensExpr) throws Exception{	
 	...
 	protected LoginHistory saveLoginHistoryDetail(BankUserContext userContext, LoginHistory loginHistory) throws Exception{	
 	...
 	public LoginHistory loadLoginHistory(BankUserContext userContext, String loginHistoryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LoginHistory searchLoginHistory(BankUserContext userContext, String loginHistoryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LoginHistory present(BankUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens) throws Exception {
 	...
 	public LoginHistory loadLoginHistoryDetail(BankUserContext userContext, String loginHistoryId) throws Exception{	
 	...
 	public Object view(BankUserContext userContext, String loginHistoryId) throws Exception{	
 		LoginHistory loginHistory = loadLoginHistory( userContext, loginHistoryId, viewTokens());
 		return present(userContext,loginHistory, allTokens());
		
 	}
 	protected LoginHistory saveLoginHistory(BankUserContext userContext, LoginHistory loginHistory, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getLoginHistoryDAO().save(loginHistory, tokens);
 	}
 	protected LoginHistory loadLoginHistory(BankUserContext userContext, String loginHistoryId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfLoginHistory(loginHistoryId);
		userContext.getChecker().throwExceptionIfHasErrors( LoginHistoryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(BankUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(BankUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLoginHistory(BankUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LoginHistory clone(BankUserContext userContext, String fromLoginHistoryId) throws Exception{
	...
	public LoginHistory internalSaveLoginHistory(BankUserContext userContext, LoginHistory loginHistory, Map<String,Object> options) throws Exception 
	{
	...
	public LoginHistory updateLoginHistoryProperty(BankUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingLoginHistory(userContext, loginHistoryId, loginHistoryVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(BankUserContext userContext, String loginHistoryId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(BankUserContext userContext, String loginHistoryId, String anotherLogin) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithLogin(BankUserContext userContext, String loginHistoryId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(BankUserContext userContext, String loginHistoryId, String anotherEmail) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithEmail(BankUserContext userContext, String loginHistoryId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(BankUserContext userContext, String loginHistoryId, String anotherMobile) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithMobile(BankUserContext userContext, String loginHistoryId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(BankUserContext userContext, String loginHistoryId, int loginHistoryVersion) throws Exception {
	...
	public LoginHistory forgetByAll(BankUserContext userContext, String loginHistoryId, int loginHistoryVersion) throws Exception {
		return forgetByAllInternal(userContext, loginHistoryId, loginHistoryVersion);		
	}
	protected LoginHistory forgetByAllInternal(BankUserContext userContext,
			String loginHistoryId, int loginHistoryVersion) throws Exception{
