...
package _jsp._coreview._com._doublechain._bank._account;
...
public class _Account$List__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
 	...
 	//the reason using scriptlet here is the el express is currently not able resolv common property from a subclass of list
        ...
        java.lang.Object _jsp_items_7 = _caucho_expr_35.evalObject(_jsp_env);
        ...
        while (_jsp_iter_7.hasNext()) {
          ...
          if (_caucho_expr_26.evalBoolean(_jsp_env)) {
            ...
            _jsp_FormatNumberTag_1.setValue(_caucho_expr_39.evalObject(_jsp_env));
          ...
          if (_caucho_expr_28.evalBoolean(_jsp_env)) {
            ...
            if (_jsp_FormatDateTag_2 == null) {
              ...
              _jsp_FormatDateTag_2.setParent(com.caucho.jsp.JspUtil.toTag(_jsp_loop_0));
              _jsp_FormatDateTag_2.setPattern("yyyy-MM-dd'T'HH:mm:ss");
            }

            _jsp_FormatDateTag_2.setValue(_caucho_expr_40.evalObject(_jsp_env));
          ...
          if (_caucho_expr_30.evalBoolean(_jsp_env)) {
            ...
            _jsp_FormatDateTag_2.setValue(_caucho_expr_41.evalObject(_jsp_env));
            _jsp_FormatDateTag_2.doEndTag();
            out.write(_jsp_string42, 0, _jsp_string42.length);
          }
          if (_caucho_expr_32.evalBoolean(_jsp_env)) {
    ...
    throws ServletException
  {
    ...
    _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ empty accountList}");
    _caucho_expr_1 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@not_found']}");
    _caucho_expr_2 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['account']}");
    ...
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty accountList}");
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'accountList' eq action.actionGroup}");
    ...
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${accountListName}");
    ...
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['account.id']}");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'name'}");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['account.name']}");
    _caucho_expr_26 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'balance'}");
    _caucho_expr_27 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['account.balance']}");
    _caucho_expr_28 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'createTime'}");
    _caucho_expr_29 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['account.create_time']}");
    _caucho_expr_30 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'updateTime'}");
    _caucho_expr_31 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['account.update_time']}");
    _caucho_expr_32 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'platform'}");
    _caucho_expr_33 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['account.platform']}");
    _caucho_expr_34 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@action']}");
    _caucho_expr_35 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${accountList}");
    _caucho_expr_36 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.version}");
    _caucho_expr_37 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.id}");
    _caucho_expr_38 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.name}");
    _caucho_expr_39 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.balance}");
    _caucho_expr_40 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.createTime}");
    _caucho_expr_41 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.updateTime}");
    _caucho_expr_42 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'$'}");
    _caucho_expr_43 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.platform}");
    _caucho_expr_44 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.platform.id}");
    _caucho_expr_45 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.platform.displayName}");
    _caucho_expr_46 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.platform}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechain/bank/account/Account$List.jsp"), 5819052558832620814L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string62 = "\n		\n		</tbody>\n	</table>	\n	\n\n</div>".toCharArray();
    _jsp_string45 = "	<td contenteditable='true' class='edit-value'  propertyToChange='updateTime' storedCellValue='".toCharArray();
    _jsp_string13 = " btn-sm\" href=\"".toCharArray();
    _jsp_string12 = "\n		<a class=\"btn btn-".toCharArray();
    _jsp_string50 = "\n			<a href='./platformManager/view/".toCharArray();
    _jsp_string25 = "/' \n			class='page-link page-action '>".toCharArray();
    _jsp_string0 = "\n\n\n\n\n\n\n".toCharArray();
    _jsp_string40 = "Manager/updateAccount/".toCharArray();
    _jsp_string29 = "\n	<th>".toCharArray();
    _jsp_string48 = "/\"\n			data-link-template=\"./platformManager/view/".toCharArray();
    _jsp_string14 = "\">".toCharArray();
    _jsp_string55 = "\n\n				<td>\n\n				<a href='#".toCharArray();
    _jsp_string26 = "</a>\n	</li>\n".toCharArray();
    _jsp_string60 = "/' class='copy-action btn btn-success btn-xs'><i class=\"fa fa-files-o fa-lg\"></i> ".toCharArray();
    _jsp_string52 = "\n			".toCharArray();
    _jsp_string37 = "</a></td>\n".toCharArray();
    _jsp_string21 = "\">\n		<a href='#".toCharArray();
    _jsp_string44 = "	<td contenteditable='true' class='edit-value'  propertyToChange='createTime' storedCellValue='".toCharArray();
    ...
    _jsp_string6 = "\n\n\n\n\n	\n\n ".toCharArray();
    _jsp_string1 = "\n\n\n".toCharArray();
    _jsp_string34 = "' id=\"account-".toCharArray();
    _jsp_string33 = "\n				<tr currentVersion='".toCharArray();
    _jsp_string46 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./accountManager/requestCandidatePlatform/".toCharArray();
    _jsp_string30 = "</th>\n".toCharArray();
    _jsp_string8 = "\n    \n 	   \n    <div class=\"row\" style=\"font-size: 30px;\">\n		<div class=\"col-xs-12 col-md-12\" style=\"padding-left:20px\">\n		<i class='fa fa-table'></i> ".toCharArray();
    _jsp_string54 = "\n			<button class=\"btn btn-link candidate-action\">...</button>\n		</span>\n		<div class=\"candidate_span\" style=\"display:none;\">\n			<input type=\"text\" data-provide=\"typeahead\" class=\"input-sm form-control candidate-filter-input\" autocomplete=\"off\" />\n		</div>\n	</td>\n".toCharArray();
    _jsp_string2 = "\n	<div class=\"row\" style=\"font-size: 30px;\">\n		<div class=\"col-xs-12 col-md-12\" style=\"padding-left:20px\">\n		 ".toCharArray();
    _jsp_string56 = "Manager/removeAccount/".toCharArray();
    _jsp_string17 = "\n	</div><!--end of div class=\"btn-group\" -->\n	\n		 \n		 \n		 \n		 </div>\n </div>\n    \n    \n<div class=\"table-responsive\">\n\n\n".toCharArray();
    _jsp_string43 = "	<td contenteditable='true' class='edit-value money'  propertyToChange='balance' storedCellValue='".toCharArray();
    _jsp_string28 = "'>\n		<thead><tr>\n		".toCharArray();
    _jsp_string47 = "/\"\n			data-switch-method=\"./accountManager/transferToAnotherPlatform/".toCharArray();
    _jsp_string61 = " </a>\n\n				</td>\n				</tr>\n			".toCharArray();
    _jsp_string35 = "\" ><td><a class=\"link-action-removed\" href=\"./accountManager/view/".toCharArray();
    _jsp_string16 = "\n	".toCharArray();
    ...
    _jsp_string32 = "</th>\n		</tr></thead>\n		<tbody>\n			\n			".toCharArray();
    _jsp_string57 = "/' class='delete-action btn btn-danger btn-xs'><i class=\"fa fa-trash-o fa-lg\"></i> ".toCharArray();
    _jsp_string31 = "\n<th>".toCharArray();
    _jsp_string23 = "CurrentPage=".toCharArray();
    _jsp_string7 = "\n    \n    \n".toCharArray();
    _jsp_string4 = "Manager/addAccount/".toCharArray();
    _jsp_string19 = " \n".toCharArray();
    _jsp_string59 = "Manager/copyAccountFrom/".toCharArray();
    _jsp_string42 = "</td>\n".toCharArray();
    _jsp_string27 = "\n </ul>\n</nav>\n\n\n   \n\n\n	<table class=\"table table-striped\" pageToken='accountListCurrentPage=".toCharArray();
    _jsp_string53 = "\n			<a href='#'></a>\n			".toCharArray();
    _jsp_string15 = "</a>\n		".toCharArray();
  }
}
