...
public class _Account__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      pageContext.requestSetOrRemove("ownerBeanName", "account");
      out.write('\n');
      pageContext.requestSetOrRemove("ownerClassName", "Account");
      ...
      pageContext.requestSetOrRemove("account", _caucho_expr_9.evalObject(_jsp_env));
      out.write('\n');
      _jsp__include__tag_1 = new _jsp._tags._include__tag();
      _jsp__include__tag_1.setJspContext(pageContext);
      _jsp__include__tag_1.setPage("com/doublechain/bank/account/Account$Summary.jsp");
      _jsp__include__tag_1.doTag();
      out.write(_jsp_string15, 0, _jsp_string15.length);
      pageContext.requestSetOrRemove("platform", _caucho_expr_10.evalObject(_jsp_env));
      out.write('\n');
      ...
      if (_caucho_expr_11.evalBoolean(_jsp_env)) {
        ...
        pageContext.requestSetOrRemove("transactionList", _caucho_expr_12.evalObject(_jsp_env));
        out.write(_jsp_string17, 0, _jsp_string17.length);
        pageContext.requestSetOrRemove("transactionListName", "transactionListAsFromAccount");
        ...
        _jsp__include__tag_2.setReferName("fromAccount");
      ...
      if (_caucho_expr_13.evalBoolean(_jsp_env)) {
        out.write(_jsp_string17, 0, _jsp_string17.length);
        pageContext.requestSetOrRemove("transactionList", _caucho_expr_14.evalObject(_jsp_env));
        out.write(_jsp_string17, 0, _jsp_string17.length);
        pageContext.requestSetOrRemove("transactionListName", "transactionListAsToAccount");
        out.write(_jsp_string21, 0, _jsp_string21.length);
        _jsp__include__tag_2 = new _jsp._tags._include__tag();
        _jsp__include__tag_2.setJspContext(pageContext);
        _jsp__include__tag_2.setPage("com/doublechain/bank/transaction/Transaction$List.jsp");
        _jsp__include__tag_2.setReferName("toAccount");
        _jsp__include__tag_2.doTag();
        out.write(_jsp_string19, 0, _jsp_string19.length);
      }
      out.write(_jsp_string20, 0, _jsp_string20.length);
      if (_caucho_expr_15.evalBoolean(_jsp_env)) {
        out.write(_jsp_string17, 0, _jsp_string17.length);
        pageContext.requestSetOrRemove("accountChangeList", _caucho_expr_16.evalObject(_jsp_env));
        out.write(_jsp_string17, 0, _jsp_string17.length);
        ...
        _jsp__include__tag_2.setReferName("account");
        _jsp__include__tag_2.doTag();
        out.write(_jsp_string19, 0, _jsp_string19.length);
      }
    ...
    throws ServletException
  {
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['account_change']}");
    _caucho_expr_9 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ result}");
    _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ result.platform}");
    _caucho_expr_11 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"transactionListAsFromAccount\"] or ignoreListAccessControl}");
    _caucho_expr_12 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.transactionListAsFromAccount}");
    _caucho_expr_13 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"transactionListAsToAccount\"] or ignoreListAccessControl}");
    _caucho_expr_14 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.transactionListAsToAccount}");
    _caucho_expr_15 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"accountChangeList\"] or ignoreListAccessControl}");
    _caucho_expr_16 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.accountChangeList}");
    _caucho_expr_17 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@home_page']}");
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@message']}");
    _caucho_expr_19 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@log_out']}");
    _caucho_expr_20 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@qr_code']}");
    _caucho_expr_21 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@qr_scan_to_continue']}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechain/bank/account/Account.jsp"), 782394247315716770L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string11 = "\n			<li><a data-toggle=\"tab\" href=\"#transactionListAsFromAccount\" class=\"disabled\"> ".toCharArray();
    _jsp_string17 = "\n		".toCharArray();
    _jsp_string1 = "\n\n\n<!DOCTYPE html>\n<html lang=\"en\" slick-uniqueid=\"3\"><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\">\n	<base href=\"".toCharArray();
    _jsp_string12 = "</a></li>\n			<li><a data-toggle=\"tab\" href=\"#transactionListAsToAccount\" class=\"disabled\"> ".toCharArray();
