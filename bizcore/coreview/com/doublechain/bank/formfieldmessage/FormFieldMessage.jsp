<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.formfieldmessage.FormFieldMessage'%>
...
<sky:include page="com/doublechain/bank/formfieldmessage/FormFieldMessage$Summary.jsp" />
