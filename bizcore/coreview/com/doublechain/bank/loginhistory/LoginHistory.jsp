<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechain/bank/loginhistory/LoginHistory$Summary.jsp" />
