...
<div class="col-xs-12 col-md-12 section">
	<b title="A NameChangeEvent"> 
		${userContext.localeMap['name_change_event']}${userContext.localeMap['@word_space']}${userContext.localeMap['@summary']}
		</b>
...
<span class="summary-label">${userContext.localeMap['name_change_event.id']}</span>
<span >${result.id}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
