<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.namechangeevent.NameChangeEvent'%>
...
<c:set var="ownerBeanName" value="nameChangeEvent" scope="request"/>
<c:set var="ownerClassName" value="NameChangeEvent" scope="request"/>
...
<div class="row">
	...
	<% NameChangeEvent result = (NameChangeEvent)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="nameChangeEvent" value="${ result}" scope="request" />
<sky:include page="com/doublechain/bank/namechangeevent/NameChangeEvent$Summary.jsp" />
	...
	<div class="row">
<c:set var="account" value="${ result.account}" scope="request" />
