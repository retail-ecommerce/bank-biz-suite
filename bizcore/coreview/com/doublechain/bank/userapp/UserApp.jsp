<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.userapp.UserApp'%>
...
<sky:include page="com/doublechain/bank/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechain/bank/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechain/bank/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechain/bank/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
