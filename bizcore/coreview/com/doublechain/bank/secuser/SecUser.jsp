<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.secuser.SecUser'%>
...
<sky:include page="com/doublechain/bank/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechain/bank/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/doublechain/bank/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechain/bank/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechain/bank/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
