<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.listaccess.ListAccess'%>
...
<sky:include page="com/doublechain/bank/listaccess/ListAccess$Summary.jsp" />
