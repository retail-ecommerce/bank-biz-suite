<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.transaction.Transaction'%>
...
<c:set var="ownerBeanName" value="transaction" scope="request"/>
<c:set var="ownerClassName" value="Transaction" scope="request"/>
...
<div class="row">
	...
	<% Transaction result = (Transaction)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="transaction" value="${ result}" scope="request" />
<sky:include page="com/doublechain/bank/transaction/Transaction$Summary.jsp" />
	...
	<div class="row">
<c:set var="account" value="${ result.fromAccount}" scope="request" />
<c:set var="referName" value="(fromAccount)" scope="request" />
<sky:include page="com/doublechain/bank/account/Account$Info.jsp" />

<c:set var="account" value="${ result.toAccount}" scope="request" />
<c:set var="referName" value="(toAccount)" scope="request" />
<sky:include page="com/doublechain/bank/account/Account$Info.jsp" />
