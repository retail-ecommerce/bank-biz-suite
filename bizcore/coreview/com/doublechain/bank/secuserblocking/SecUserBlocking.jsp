<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechain/bank/secuserblocking/SecUserBlocking$Summary.jsp" />
