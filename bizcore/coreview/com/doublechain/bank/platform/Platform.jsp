<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.platform.Platform'%>
...
<sky:include page="com/doublechain/bank/platform/Platform$Summary.jsp" />
		...
		<div id="changeRequestList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechain/bank/changerequest/ChangeRequest$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["accountList"] or ignoreListAccessControl}'>
		<c:set var="accountList" value="${result.accountList}" scope="request"/>
		<c:set var="accountListName" value="accountList" scope="request"/>
		<div id="accountList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechain/bank/account/Account$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
