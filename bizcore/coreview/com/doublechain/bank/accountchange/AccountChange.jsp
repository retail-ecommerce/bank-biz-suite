<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.accountchange.AccountChange'%>
...
<c:set var="ownerBeanName" value="accountChange" scope="request"/>
<c:set var="ownerClassName" value="AccountChange" scope="request"/>
...
<div class="row">
	...
	<% AccountChange result = (AccountChange)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="accountChange" value="${ result}" scope="request" />
<sky:include page="com/doublechain/bank/accountchange/AccountChange$Summary.jsp" />
