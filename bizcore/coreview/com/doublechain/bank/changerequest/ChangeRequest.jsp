<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.changerequest.ChangeRequest'%>
...
<sky:include page="com/doublechain/bank/changerequest/ChangeRequest$Summary.jsp" />
...
<sky:include page="com/doublechain/bank/platform/Platform$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["transactionList"] or ignoreListAccessControl}'>
		<c:set var="transactionList" value="${result.transactionList}" scope="request"/>
