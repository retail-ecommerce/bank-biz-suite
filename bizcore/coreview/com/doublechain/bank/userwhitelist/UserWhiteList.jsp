<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechain/bank/userwhitelist/UserWhiteList$Summary.jsp" />
