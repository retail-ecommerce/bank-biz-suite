<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.formmessage.FormMessage'%>
...
<sky:include page="com/doublechain/bank/formmessage/FormMessage$Summary.jsp" />
