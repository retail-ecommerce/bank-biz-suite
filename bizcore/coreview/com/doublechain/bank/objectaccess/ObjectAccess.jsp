<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.objectaccess.ObjectAccess'%>
...
<sky:include page="com/doublechain/bank/objectaccess/ObjectAccess$Summary.jsp" />
...
<sky:include page="com/doublechain/bank/userapp/UserApp$Info.jsp" />
